...
yaml_dir = home_dir + '/Voc/config/sim.yaml'
# yaml_dir = home_dir + '/Voc/config/sim_mono.yaml'

def generate_launch_description():
    rgb_topic_arg = DeclareLaunchArgument('rgb_topic', default_value='/camera/img')
    depth_topic_arg = DeclareLaunchArgument('depth_topic', default_value='/camera/depth')
