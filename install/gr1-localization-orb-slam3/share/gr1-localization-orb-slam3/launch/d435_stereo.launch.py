...
configurable_parameters = [{'name': 'camera_name',                  'default': 'camera', 'description': 'camera unique name'},
                           ...
                           {'name': 'depth_module.infra_profile',         'default': '640,480,30', 'description': 'depth module profile'},                           
                           {'name': 'enable_depth',                 'default': 'false', 'description': 'enable depth stream'},
                           {'name': 'rgb_camera.color_profile',           'default': '640,480,30', 'description': 'color image width'},
