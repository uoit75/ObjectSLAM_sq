...
public:
    ...
    bool static InertialOptimization(Map *pMap, Eigen::Vector3d &bg, float priorG=1e2);
    //[superquadric]Object optimize
    void static ObjectOptimize(Map *pMap, Object* MapObjects);
    void static ObjectOptimizeE12(Map *pMap, Object* MapObjects);
    void static SaveOptimizeInformation(const string &filename, Object* MapObjects);
    void static ObjectOptimizeForAnalyse(Map *pMap, Object* MapObjects); 
    void static ObjectOptimizeSimulatedAnnealing(Map *pMap, Object* MapObjects);
