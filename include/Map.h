...
public:
    ...
    // Object_Map* OBJECTS;
    // std::vector<Object::Object_3D>Objects;
    Object* MapObjects; 
    Object* TestObjects;//测试到相机距离用
    std::vector<Eigen::Vector3f>ObjectCenters;
    void AddObjectCenter(Eigen::Vector3f Object_Cts);
    void AddObject(Object newobjects, bool WhetherFirst);
    void AddObjectForTest(Object newobjects, bool WhetherFirst);//测试到相机距离用
